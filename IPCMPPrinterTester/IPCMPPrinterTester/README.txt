/********************************************* QUICK START *********************************************
*
* In order to use this sample project you need will need:
*
* - Apple Developer account to sign the application.
* - IPC Developer account to get access to the InfineaSDK & IPCMPPrinterSDK frameworks.
* - IPC Developer Key. If you do not have this, contact your IPC representative.
*
*
